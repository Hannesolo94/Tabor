...
export async function getCollectionBySlug(slug: string, ctx: PriceContext): Promise<{ collection: Collection; products: Product[] } | null> {
  ...
  // pull all live products for the currency, keep those in this collection, preserve order
