  ...
  return (
    <LegalPage title="Shipping" updated="June 2026">
      ...
      <Section h="Shipping costs and times">
        Shipping is calculated at checkout based on your destination. Estimated delivery windows are shown before you pay. These are estimates, not guarantees, and can be affected by carriers, customs, and peak periods.
      </Section>
