...
import { Cinzel, Cormorant_Garamond, Inter, JetBrains_Mono, Metal_Mania, Pirata_One } from "next/font/google";
...
const metal = Metal_Mania({ subsets: ["latin"], weight: "400", variable: "--font-metal" });
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${mono.variable} ${cinzel.variable} ${pirata.variable} ${metal.variable} ${cormorant.variable}`}>
      <body>{children}</body>
    </html>
  );
}
