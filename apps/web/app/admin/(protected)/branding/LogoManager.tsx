    ...
    <section style={{ marginTop: 40 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 18 }}>
        ...
        <div className="admin-card" style={cardStyle}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div style={{ minWidth: 140, height: 72, padding: "0 14px", borderRadius: 14, background: "#0A0A0A", border: "1px solid rgba(201,169,97,0.22)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", flex: 1 }}>
              {logos.wordmark
                ? <img src={logos.wordmark} alt="Current logo" style={{ maxWidth: "100%", maxHeight: 48, objectFit: "contain" }} />
