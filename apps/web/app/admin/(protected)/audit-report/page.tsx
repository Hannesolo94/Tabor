  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        ...
        <h1 style={{ fontFamily: CINZEL, fontWeight: 700, fontSize: 30, color: "#E8E2D5", margin: 0 }}>Audit Report</h1>
        <p style={{ fontFamily: BODY, fontSize: 13, color: "#9A948A", margin: "6px 0 0", maxWidth: 640 }}>
      ...
      <div className="admin-card" style={{ ...cardStyle, marginBottom: 16 }}>
        <div style={{ fontFamily: CINZEL, fontWeight: 700, fontSize: 14, color: "#E8E2D5", marginBottom: 14 }}>Findings · all resolved</div>
        <div style={{ display: "grid", gap: 10 }}>
          {FINDINGS.map((f) => (
            <div key={f.id} style={{ border: "1px solid rgba(255,255,255,0.05)", background: "rgba(15,15,20,0.4)", borderRadius: 12, padding: "14px 16px" }}>
