...
export default async function Admins() {
  ...
  return (
    <div>
      ...
      <form action={grantAdmin} className="admin-card" style={{ ...cardStyle, maxWidth: 560, marginBottom: 22 }}>
        <div style={cardTitle}>Grant access</div>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button type="submit" style={btnGold}>Grant</button>
        </div>
      </form>
