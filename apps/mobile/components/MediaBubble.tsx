...
export function MediaBubble({ media }: { media: MediaRef }) {
  if (media.t === "video") {
    ...
    return (
      <Pressable onPress={() => Linking.openURL(media.url)} style={{ width: 220, height: 140, borderRadius: 4, backgroundColor: "#000", borderWidth: 1, borderColor: C.line, alignItems: "center", justifyContent: "center" }}>
