      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 40 }}>
        {composing && (
          <View style={{ borderWidth: 1, borderColor: C.gold, borderRadius: 3, padding: 14, marginBottom: 18 }}>
            ...
            <Pressable onPress={save} style={{ backgroundColor: C.gold, paddingVertical: 12, alignItems: "center", borderRadius: 2, marginTop: 10 }}>
        ...
        {notes.map((n) => (
          <Pressable key={n.id} onLongPress={() => remove(n)} delayLongPress={350} style={{ borderWidth: 1, borderColor: C.line, backgroundColor: C.surface2, borderRadius: 3, padding: 14, marginBottom: 10 }}>
