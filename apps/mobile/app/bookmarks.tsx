    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.black }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 40 }}>
        {refs.length === 0 ? (
          ...
          <Pressable key={ref} onPress={() => open(ref)} onLongPress={() => remove(ref)} delayLongPress={350} style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderWidth: 1, borderColor: C.line, backgroundColor: C.surface2, borderRadius: 2, padding: 14, marginBottom: 10 }}>
